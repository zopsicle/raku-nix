...
open(my $default, '>', 'default.nix');
$default->say("# !!! GENERATED BY tools/generate-nix.pl DO NOT EDIT");
$default->say("{ pkgs ? import ./nix/pkgs.nix {} }:");
$default->say("let");
$default->say("    package = p: r: pkgs.callPackage p ({ inherit rakuPackage rakuPackages; } // r);");
$default->say("    rakuPackage = pkgs.callPackage ./tools/rakuPackage.nix {};");
...
for (@libraries) {
    ...
    $default->say("        \"$name\" = package (./. + \"/ecosystem/$name.nix\") {};");
}
$default->say("    };");
$default->say("in");
$default->say("    { inherit rakuPackage; } // rakuPackages");
